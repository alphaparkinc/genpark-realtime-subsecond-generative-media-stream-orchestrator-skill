# genpark-realtime-subsecond-generative-media-stream-orchestrator-skill
...
> **GenPark AI Agent Skill** -- Real-time sub-second generative media stream orchestrator (Fal style)
